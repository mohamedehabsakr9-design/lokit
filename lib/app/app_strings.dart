...
class AppStrings {
  ...
  String get notificationsEmpty =>
      isArabic ? 'لا توجد إشعارات' : 'No Notification';
...
String get pleaseFillAllFields => 'يرجى ملء جميع الحقول';
  ...
  String get chatInputHint =>
      isArabic ? 'اكتب الرسالة...' : 'Type message...';
  ...
  // هذه القيم هي التي كانت ناقصة وتسببت في الخطأ
  ...
  String get productReviewUserName =>
      isArabic ? 'اسم العميل' : 'User Name';
  ...
  String get cartTotalItemsLabel =>
      isArabic ? 'الإجمالي (2 منتج) :' : 'Total (2 item) :';
  ...
  String get cartPriceExample =>
      isArabic ? '1000 ج.م' : '1000 EGP';
  ...
  String get paymentSubTotalLabel =>
      isArabic ? 'الإجمالي الفرعي (2)' : 'Sub total (2)';
  ...
  String get paymentFullNameHint =>
      isArabic ? 'الاسم الكامل' : 'Full Name';
  String get paymentPhoneHint =>
      isArabic ? 'رقم الهاتف' : 'Phone Number';
  String get paymentAddressHint =>
      isArabic ? 'العنوان' : 'Address';
  String get paymentCityHint => isArabic ? 'المدينة' : 'City';
  String get paymentPostalHint =>
      isArabic ? 'الرمز البريدي' : 'Postel Code';
  ...
  String get paymentExpHint =>
      isArabic ? 'تاريخ الانتهاء' : 'Exp date';
  ...
  String get orderConfirmTrackButton =>
  ...
  String get wishlistProductName =>
      isArabic ? 'اسم المنتج' : 'Product name';
  String get wishlistBrand => isArabic ? 'الماركة' : 'Brand';
  String get wishlistPriceExample =>
      isArabic ? '1000 ج.م' : '1000 EGP';

  // ===================== My Orders =====================
  String get myOrdersTitle => isArabic ? 'طلباتي' : 'My Orders';
  String get myOrdersPendingTab =>
      isArabic ? 'قيد الانتظار' : 'Pending';
  String get myOrdersCompletedTab =>
      isArabic ? 'مكتملة' : 'Completed';
  String get myOrdersEmptyText =>
      isArabic ? 'لا توجد طلبات حالياً' : 'No orders yet';
  String get myOrdersOrderLabel =>
      isArabic ? 'طلب' : 'Order';
  String get myOrdersDateTimeLabel =>
      isArabic ? 'التاريخ والوقت' : 'Date & Time';
  String get myOrdersPendingStatus =>
      isArabic ? 'قيد الانتظار' : 'Pending';
  String get myOrdersCompletedStatus =>
      isArabic ? 'مكتمل' : 'Completed';
  String get myOrdersDetailsButton =>
  ...
  String get orderDetailsSectionTitle =>
      isArabic ? 'بيانات الطلب' : 'Order details';
  String get orderDetailsStatusLabel =>
      isArabic ? 'حالة الطلب' : 'Order Status';
  String get orderDetailsNumberLabel =>
      isArabic ? 'رقم الطلب' : 'Order Number';
  String get orderDetailsDateLabel =>
      isArabic ? 'تاريخ الطلب' : 'Order Date';
  String get orderDetailsPaymentMethodLabel =>
      isArabic ? 'طريقة الدفع' : 'Payment Method';
  String get orderDetailsPhoneLabel =>
      isArabic ? 'رقم الهاتف' : 'Phone Number';
  String get orderDetailsAddressLabel =>
      isArabic ? 'عنوان الشحن' : 'Shipping Address';
  ...
  String get orderDetailsStatusSectionTitle =>
      isArabic ? 'حالة الطلب' : 'Order Status';
  String get timelineConfirmedTitle =>
      isArabic ? 'تم تأكيد الطلب' : 'Order Confirmed';
  String get timelineConfirmedBody => isArabic
      ? 'استلمنا طلبك وبدأنا في تحضيره'
      : 'We have received your order and started preparing it';
  String get timelineShippedTitle =>
      isArabic ? 'تم الشحن' : 'Shipped';
  String get timelineShippedBody => isArabic
      ? 'طلبك في الطريق إليك مع شركة الشحن'
      : 'Your package is on its way to you with the courier';
  String get timelineDeliveredTitle =>
      isArabic ? 'تم التوصيل' : 'Delivered';
  String get timelineDeliveredBody => isArabic
      ? 'تم توصيل طلبك بنجاح'
      : 'Your order has been successfully delivered';

  String get orderRateSectionTitle =>
      isArabic ? 'قيّم طلبك' : 'Rate Your Order';
  String get orderRateSectionBody => isArabic
      ? 'بعد استلام طلبك، نود معرفة رأيك وتجربتك.'
      : 'After receiving your order, we would love to know your feedback.';
  String get orderRateButton =>
      isArabic ? 'قيّم طلبك' : 'Rate Your Order';

  String get orderCancelSectionTitle =>
      isArabic ? 'هل تريد إلغاء الطلب؟' : 'Want to Cancel Your Order?';
  String get orderCancelSectionBody => isArabic
      ? 'يمكنك إلغاء طلبك في أي وقت قبل الشحن.'
  ...
  String get rateProductQualityLabel =>
      isArabic ? 'جودة المنتج' : 'Product Quality';
  String get rateSizeFitLabel =>
      isArabic ? 'المقاس والملاءمة' : 'Size & Fit';
  String get rateDeliveryLabel =>
      isArabic ? 'تجربة التوصيل' : 'Delivery Experience';
  String get ratePackagingLabel =>
      isArabic ? 'التغليف' : 'Packaging';
  String get rateNotesLabel => isArabic ? 'ملاحظات' : 'Notes';
  String get rateNotesHint =>
      isArabic ? 'اكتب تقييمك هنا...' : 'Write your review here...';
  ...
  String get aiPreviewNoImage =>
      isArabic ? 'لم يتم اختيار صورة' : 'No image selected';
  String get aiPreviewTryOnButton =>
      isArabic ? '✨ جرّب المنتج' : '✨ Try On Product';
  ...
  String get aiSheetSubtitle =>
      isArabic ? 'اختر مصدر الصورة' : 'Select an image source';
  String get aiSheetInstructionsTitle =>
      isArabic ? 'إرشادات الصورة' : 'Photo Instructions';
